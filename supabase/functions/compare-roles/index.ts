...
const rolesCatalog = [
  ...
  {
    "role_id": "assistente_rh",
    "title": "Assistente de RH",
    "category": "Recursos Humanos",
    "seniority": "Júnior",
    "core_focus": ["Suporte administrativo", "Processos de RH"],
    "main_responsibilities": ["Apoiar processos de admissão e demissão", "Organizar documentação de colaboradores", "Atender colaboradores em dúvidas sobre benefícios e folha"],
    "key_skills": ["organização", "atendimento", "sistemas de RH"],
    "typical_metrics": ["Tempo de resposta", "Erros em documentação"],
    "typical_team_size": "1-5",
    "project_scope": "Rotinas administrativas de RH",
    "when_to_choose": "Para suporte em rotinas de RH e atendimento aos colaboradores",
    "risks": "Baixa autonomia; depende de supervisão para decisões"
  },
  {
    "role_id": "analista_rh",
    ...
    "category": "Recursos Humanos",
    "seniority": "Pleno",
    "core_focus": ["Gestão de processos de RH", "Análise de indicadores"],
    "main_responsibilities": ["Conduzir processos de R&S", "Analisar indicadores de RH (turnover, absenteísmo)", "Apoiar ações de clima e engajamento"],
    "key_skills": ["análise de dados de RH", "processos de RH", "comunicação"],
    "typical_metrics": ["Time-to-hire", "Turnover", "eNPS"],
    "typical_team_size": "1-8",
    "project_scope": "Processos de RH contínuos",
    "when_to_choose": "Quando precisa de alguém para executar e analisar processos de gestão de pessoas",
    "risks": "Pode ficar operacional demais sem visão estratégica"
  },
  {
    "role_id": "analista_recrutamento",
    "title": "Analista de Recrutamento e Seleção",
    "category": "Recursos Humanos",
    "seniority": "Pleno",
    "core_focus": ["Atração de talentos", "Seleção de candidatos"],
    "main_responsibilities": ["Conduzir processos seletivos end-to-end", "Realizar hunting e sourcing", "Conduzir triagens e entrevistas por competência"],
    "key_skills": ["sourcing", "entrevistas por competência", "employer branding"],
    "typical_metrics": ["Time-to-fill", "Qualidade de contratação", "SLA de vagas"],
    "typical_team_size": "1-6",
    "project_scope": "Processos seletivos",
    "when_to_choose": "Quando há volume de vagas e necessidade de qualidade nas contratações",
    "risks": "Foco em volume pode comprometer qualidade das contratações"
  },
  {
    "role_id": "business_partner_rh",
    "title": "Business Partner de RH (HRBP)",
    "category": "Recursos Humanos",
    "seniority": "Sênior",
    "core_focus": ["Consultoria interna", "Alinhamento estratégico"],
    "main_responsibilities": ["Apoiar líderes em decisões de pessoas", "Mediar conflitos e situações sensíveis", "Implementar políticas de RH nas áreas"],
    "key_skills": ["consultoria", "gestão de conflitos", "visão de negócio"],
    "typical_metrics": ["Engajamento das áreas", "Retenção de talentos", "Satisfação dos gestores"],
    "typical_team_size": "1-3 por área atendida",
    "project_scope": "Consultoria estratégica para áreas de negócio",
    "when_to_choose": "Quando há necessidade de RH próximo às áreas de negócio para decisões estratégicas de pessoas",
    "risks": "Pode ficar preso em demandas operacionais das áreas"
  },
  {
    "role_id": "coordenador_rh",
    "title": "Coordenador de RH",
    "category": "Recursos Humanos",
    "seniority": "Pleno/Sênior",
    "core_focus": ["Gestão de equipe de RH", "Processos integrados"],
    "main_responsibilities": ["Coordenar time de RH", "Garantir execução de políticas de pessoas", "Acompanhar indicadores e propor melhorias"],
    "key_skills": ["liderança", "gestão de processos de RH", "comunicação"],
    "typical_metrics": ["Eficiência de processos de RH", "Satisfação interna", "Cumprimento de SLAs"],
    "typical_team_size": "3-10",
    "project_scope": "Operações de RH",
    "when_to_choose": "Quando há equipe de RH a ser coordenada e necessidade de integrar processos",
    "risks": "Pode ficar sobrecarregado com demandas operacionais"
  },
  {
    "role_id": "especialista_dp",
    "title": "Especialista em Departamento Pessoal",
    "category": "Recursos Humanos",
    "seniority": "Pleno/Sênior",
    "core_focus": ["Folha de pagamento", "Compliance trabalhista"],
    "main_responsibilities": ["Processar folha de pagamento", "Gerenciar benefícios", "Garantir conformidade com legislação trabalhista"],
    "key_skills": ["legislação trabalhista", "cálculos de folha", "sistemas de DP"],
    "typical_metrics": ["Erros em folha", "Conformidade com prazos legais", "Custo de benefícios"],
    "typical_team_size": "1-5",
    "project_scope": "Administração de pessoal",
    "when_to_choose": "Quando há necessidade de expertise em folha, benefícios e compliance trabalhista",
    "risks": "Foco excessivo em compliance pode gerar burocracia"
  },
  {
    "role_id": "especialista_treinamento",
    "title": "Especialista em Treinamento e Desenvolvimento",
    "category": "Recursos Humanos",
    "seniority": "Pleno/Sênior",
    "core_focus": ["Capacitação", "Desenvolvimento de pessoas"],
    "main_responsibilities": ["Desenhar programas de treinamento", "Avaliar gaps de competência", "Facilitar workshops e treinamentos"],
    "key_skills": ["design instrucional", "facilitação", "avaliação de competências"],
    "typical_metrics": ["Horas de treinamento", "NPS de treinamentos", "Evolução de competências"],
    "typical_team_size": "1-4",
    "project_scope": "Desenvolvimento organizacional",
    "when_to_choose": "Quando há necessidade de desenvolver competências e cultura de aprendizado",
    "risks": "Treinamentos mal desenhados podem ter baixo impacto"
  },
  {
    "role_id": "gerente_rh",
    "title": "Gerente de RH",
    "category": "Recursos Humanos",
    "seniority": "Sênior",
    "core_focus": ["Estratégia de pessoas", "Gestão de RH"],
    "main_responsibilities": ["Definir políticas de gestão de pessoas", "Gerenciar equipe de RH", "Alinhar RH com estratégia de negócio"],
    "key_skills": ["gestão estratégica de pessoas", "liderança", "planejamento"],
    "typical_metrics": ["Turnover", "eNPS", "Custo por contratação", "Engajamento"],
    "typical_team_size": "5-20",
    "project_scope": "Gestão completa de RH",
    "when_to_choose": "Quando a empresa precisa de liderança para estruturar e evoluir a área de RH",
    "risks": "Foco em políticas pode distanciar da execução e necessidades reais"
  },
  {
    "role_id": "diretor_rh",
    ...
    "category": "Recursos Humanos",
    "seniority": "Executivo",
    "core_focus": ["Estratégia de capital humano", "Cultura organizacional"],
    "main_responsibilities": ["Definir estratégia de pessoas", "Liderar transformação cultural", "Representar RH no board executivo"],
    "key_skills": ["liderança executiva", "gestão de mudanças", "visão estratégica"],
    "typical_metrics": ["Engajamento organizacional", "Retenção de talentos-chave", "ROI de iniciativas de RH"],
    "typical_team_size": "10+",
    "project_scope": "Estratégico / longo prazo",
    "when_to_choose": "Quando RH é diferencial estratégico e precisa de liderança executiva",
    "risks": "Foco estratégico pode perder atenção em demandas táticas se não houver camadas de gestão"
  }
];
