...
const questionTypes = [
  { value: "rating", label: "Nota (1-5)", description: "Avaliação com escala de 1 a 5" },
  { value: "open_text", label: "Texto Aberto", description: "Resposta dissertativa" },
  { value: "multiple_choice", label: "Múltipla Escolha", description: "Opções de resposta" },
];
...
export default function ScorecardForm() {
  ...
  function addOption(criterionIndex: number) {
    ...
    newCriteria[criterionIndex].options = [...options, { text: "", is_correct: false }];
    setCriteria(newCriteria);
  }
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <RadioGroup
                value={templateType}
                onValueChange={(value) => setTemplateType(value as "entrevista" | "teste_tecnico")}
              ...
              >
                <div className="flex items-center space-x-3 p-4 border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                  ...
                  <Label htmlFor="entrevista" className="flex-1 cursor-pointer">
                    <div className="font-semibold">Avaliação de Entrevista</div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={templateType === "teste_tecnico" ? "Ex: Teste Técnico Dev Frontend" : "Ex: Avaliação Técnica Geral"}
                className="text-base"
              />
            </div>
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-2">
                          ...
                          <Select
                            value={criterion.question_type}
                            onValueChange={(value) =>
                              updateCriterion(index, "question_type", value)
                            }
                          >
                        ...
                        <Input
                          ...
                          placeholder={
                            criterion.question_type === "open_text"
                              ? "Ex: Descreva sua experiência com React e TypeScript"
                              : criterion.question_type === "multiple_choice"
                              ? "Ex: Qual framework você tem mais experiência?"
                              : "Ex: O candidato demonstrou conhecimento técnico adequado?"
                          }
                          className="text-base"
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          placeholder={
                            templateType === "teste_tecnico"
                              ? "Instruções para o candidato responder esta pergunta"
                              : "Explique o que deve ser avaliado nesta pergunta"
                          }
                          rows={2}
                          className="text-base"
                        />
                            ...
                            {(criterion.options || []).map((option, optIndex) => (
                              <div key={optIndex} className="flex items-center gap-2">
                                {templateType === "teste_tecnico" && (
                                  <Button
                                    type="button"
                                    variant={option.is_correct ? "default" : "ghost"}
                                    size="icon"
                                  ...
                                  >
                                    <CheckCircle2
                                      className={`h-4 w-4 ${
                                        option.is_correct ? "text-white" : "text-muted-foreground"
                                      }`}
                                    />
                                  </Button>
                                )}
                                ...
                                <Button
                                  ...
                                  disabled={(criterion.options?.length || 0) <= 2}
            ...
            <div className="bg-muted p-4 rounded-lg">
              ...
              <ul className="text-base text-muted-foreground space-y-2">
                ...
                <li>
                  ...
                  {templateType === "teste_tecnico" 
                    ? " - marque a correta para calcular a nota automaticamente" 
                    : " para categorizar a resposta"}
                </li>
              </ul>
            </div>
          </CardContent>
