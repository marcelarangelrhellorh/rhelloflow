...
export default function Vagas() {
  ...
  return <div className="p-8 min-h-screen" style={{
    backgroundColor: '#FFFBF0'
  }}>
      ...
      {/* Filter chip */}
      {hasActiveFilter && <div className="mb-4 flex items-center gap-2 p-3 bg-warning/10 border border-warning/20 rounded-lg">
      ...
      <div className="mb-6 flex gap-4 flex-wrap">
        <div className="relative flex-1 min-w-[250px]">
          ...
          <Input placeholder="Buscar vagas..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10" />
        </div>
        ...
        <Select value={clienteFilter} onValueChange={setClienteFilter}>
          ...
          <SelectContent>
            ...
            {clientes.map(cli => <SelectItem key={cli} value={cli}>
                {cli}
              </SelectItem>)}
          </SelectContent>
        </Select>
