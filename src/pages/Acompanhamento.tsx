...
export default function Acompanhamento() {
  ...
  return <div className="min-h-screen bg-background">
      <div className="flex">
        {/* Main Content */}
        <div className="flex-1 p-6 space-y-6 lg:mr-[26rem] ml-8 lg:ml-16 shadow-none">
        {/* Header */}
        <div>
        ...
        {/* Metrics Cards */}
        {!selectedVaga && <div className="grid gap-4 sm:grid-cols-2 max-w-3xl mt-6">
        ...
        {selectedVaga && selectedVagaData && <div className="space-y-6 mt-6">
            ...
            {/* Process Timeline */}
            <Card className="shadow-sm max-w-6xl">
