...
export function VagaActivityLog({
  ...
  return <div>
      <h2 className="text-primary-text-light dark:text-primary-text-dark font-bold tracking-tight mb-6 mx-[15px] bg-muted/50 px-4 py-2 rounded-full text-lg my-[15px]">
        Atividade Recente
      </h2>
