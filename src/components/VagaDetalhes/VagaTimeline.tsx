...
export function VagaTimeline({ currentStatusSlug, progress }: VagaTimelineProps) {
                    ...
                    >
                      ...
                      >
                        {step.status === "completed" && (
                          <span className="material-symbols-outlined text-xl" style={{ color: "#00141D" }}>
                            check
                          </span>
                        )}
                        {step.status === "current" && (
