...
export function JobHistorySection({ vagaId }: JobHistorySectionProps) {
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: Reunião com cliente, Atualização de requisitos..."
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div 
                        className="mt-2 text-sm text-foreground/80 line-clamp-3 prose prose-sm max-w-none [&_ul]:list-disc [&_ul]:pl-4 [&_ol]:list-decimal [&_ol]:pl-4"
