...
const statusConfig: Record<TaskStatus, { icon: typeof Circle }> = {
  to_do: { icon: Circle },
  in_progress: { icon: Clock },
  done: { icon: CheckCircle2 },
};

export function VagaTasksCard({ vagaId, vagaTitulo }: VagaTasksCardProps) {
    ...
    <>
      <div className="flex flex-col gap-3 rounded-lg p-6 bg-white dark:bg-background-dark border border-gray-200 dark:border-secondary-text-light/20 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-muted-foreground">pendente{pendingTasks.length !== 1 ? "s" : ""}</span>
