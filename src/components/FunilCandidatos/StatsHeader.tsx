...
export function StatsHeader({
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      <div className="flex items-center justify-between h-[48px] px-3 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="flex-1">
          <p className="text-xs text-[#36404A] font-medium">Candidatos Ativos</p>
          <p className="text-lg font-bold text-[#00141D]">{totalCandidatosAtivos}</p>
        </div>
      ...
      <div className="flex items-center justify-between h-[48px] px-3 bg-white rounded-lg border border-gray-200 shadow-sm">
        <div className="flex-1">
          ...
          <p className="text-lg font-bold text-[#00141D]">{candidatosBancoTalentos}</p>
        </div>
