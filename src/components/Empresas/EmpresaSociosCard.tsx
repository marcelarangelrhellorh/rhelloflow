...
export function EmpresaSociosCard({
  empresa
}: EmpresaSociosCardProps) {
  ...
  return <Card className="border border-gray-300 shadow-md">
      ...
      <CardContent>
        <div className="space-y-2">
          {quadroSocietario.map((socio, index) => <div key={index} className="flex justify-between items-center p-3 bg-muted/30 rounded-lg border border-gray-200">
