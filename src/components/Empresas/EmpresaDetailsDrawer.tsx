      ...
      <SheetContent className="w-full sm:max-w-2xl overflow-y-auto">
        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="space-y-4">
            ...
            {empresa.cnpj && <div className="flex items-center gap-2 text-sm">
            ...
            {empresa.setor && <div className="flex items-center gap-2 text-sm">
            ...
            {empresa.porte && <div className="flex items-center gap-2 text-sm">
            ...
            {empresa.telefone && <div className="flex items-center gap-2 text-sm">
            ...
            {empresa.email && <div className="flex items-center gap-2 text-sm">
            ...
            {empresa.site && <div className="flex items-center gap-2 text-sm">
            ...
            {(empresa.endereco || empresa.cidade || empresa.estado) && <div className="flex items-start gap-2 text-sm">
                ...
                <div>
                  ...
                  <div className="font-medium text-[#00141D]">
                    ...
                    {(empresa.cidade || empresa.estado) && <div>
                        {empresa.cidade}
          ...
          {(empresa.contato_principal_nome || empresa.contato_principal_email || empresa.contato_principal_telefone) && <>
              ...
              <div className="space-y-4">
                ...
                {empresa.contato_principal_nome && <div className="flex items-center gap-2 text-sm">
                ...
                {empresa.contato_principal_cargo && <div className="flex items-center gap-2 text-sm">
                    <Briefcase className="h-4 w-4 text-[#36404A]" />
                ...
                {empresa.contato_principal_email && <div className="flex items-center gap-2 text-sm">
                    <Mail className="h-4 w-4 text-[#36404A]" />
                    <span className="text-[#36404A]">Email:</span>
                    <span className="font-medium text-[#00141D]">
                ...
                {empresa.contato_principal_telefone && <div className="flex items-center gap-2 text-sm">
                    <Phone className="h-4 w-4 text-[#36404A]" />
                    <span className="text-[#36404A]">Telefone:</span>
                    <span className="font-medium text-[#00141D]">
          ...
          {contratacoes && contratacoes.length > 0 && <>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  {contratacoes.map(contratacao => <Card key={contratacao.id} className="p-3 border-gray-300">
                      <div className="font-medium text-[#00141D]">
