...
export function StatsBar({
  ...
  return <div className="grid gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
      <div className="flex flex-col gap-2 rounded-lg p-6 bg-white dark:bg-background-dark border border-gray-200 dark:border-secondary-text-light/20 shadow-lg">
