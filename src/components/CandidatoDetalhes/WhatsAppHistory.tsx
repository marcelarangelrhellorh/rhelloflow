...
export function WhatsAppHistory({ candidateId }: WhatsAppHistoryProps) {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      queued: { label: "Aguardando", variant: "secondary" as const, icon: Clock },
        ...
        {sends.map((send) => (
          ...
          >
            ...
            <div className="bg-muted/50 rounded-md p-3 text-sm">
              <p className="whitespace-pre-wrap">{send.text}</p>
            </div>
