...
Localização: ${[cidade, estado].filter(Boolean).join(", ") || "Não informada"}
  ...
  return <div className="rounded-lg border border-gray-300 bg-white dark:bg-background-dark shadow-md">
      <div className="p-6 pb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h3 className="text-primary-text-light dark:text-primary-text-dark font-bold text-base">Contato</h3>
        ...
        {isFromPublicLink && <p className="text-sm text-secondary-text-light dark:text-secondary-text-dark mt-2 font-medium">
