...
export function JobDrawer({ jobId, open, onOpenChange, onEdit }: JobDrawerProps) {
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-muted-foreground">Dias úteis em aberto</p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-4 bg-muted/30 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-xs text-muted-foreground">Candidatos vinculados</p>
