...
export function PaceCard({ metrics }: PaceCardProps) {
  const {
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-primary/10 rounded-lg p-3">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xs text-muted-foreground">vagas/semana</span>
            </div>
          ...
          <div className="flex items-center justify-between py-2 border-b border-border/50">
            <div>
              <span className="text-xs text-muted-foreground block">Semana Passada</span>
              <span className="text-xs text-muted-foreground">
            ...
            <div className="text-right">
              ...
              <span className="text-xs text-muted-foreground ml-1">v/s</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <span className="text-xs text-muted-foreground block">Este Mês</span>
              <span className="text-xs text-muted-foreground">
